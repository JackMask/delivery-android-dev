package com.yum.two_yum.utile.imgborwser.adapter;
...
import com.yum.two_yum.utile.imgborwser.activity.UTImageBrowserActivity;
import com.yum.two_yum.utile.imgborwser.entity.UTImageEntity;
import com.yum.two_yum.utile.imgborwser.imageloader.UTLoader;
import com.yum.two_yum.utile.imgborwser.interfaces.ILoadingCallBack;
import com.yum.two_yum.utile.imgborwser.photoview.PhotoView;
import com.yum.two_yum.utile.imgborwser.photoview.PhotoViewAttacher;
...
public class UTPreViewAdapter extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {
    ...
    private void showMidState(UTImageEntity info, PhotoView photoView) {
        ...
        if (cacheImage == null) {
            photoView.setImageResource(R.mipmap.ease_default_avatar);
        } else {
