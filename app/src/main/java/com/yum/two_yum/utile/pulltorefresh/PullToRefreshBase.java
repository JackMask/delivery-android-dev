...
import com.yum.two_yum.utile.pulltorefresh.internal.FlipLoadingLayout;
import com.yum.two_yum.utile.pulltorefresh.internal.LoadingLayout;
import com.yum.two_yum.utile.pulltorefresh.internal.RotateLoadingLayout;
import com.yum.two_yum.utile.pulltorefresh.internal.Utils;
import com.yum.two_yum.utile.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void setGoneHead(){
		if (mHeaderLayout!=null){
			mHeaderLayout.setGoneAll();
		}
	}
	public void setGoneAll(){
		if (mFooterLayout!=null){
			mFooterLayout.setGone();
		}
	}
	@Override
