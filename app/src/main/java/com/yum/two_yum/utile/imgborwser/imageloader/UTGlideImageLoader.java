package com.yum.two_yum.utile.imgborwser.imageloader;
...
public class UTGlideImageLoader extends UTImageLoader {
    ...
    public void disPlayImage(Context context, final ImageView imageView, String url, final ILoadingCallBack loadingCallBack) {
        url = getPath(url);
        Picasso.get().load(url).placeholder(R.mipmap.ease_default_avatar).into(new com.squareup.picasso.Target() {
            @Override
