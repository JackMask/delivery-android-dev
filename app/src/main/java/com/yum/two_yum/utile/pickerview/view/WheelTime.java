package com.yum.two_yum.utile.pickerview.view;

import android.view.View;

import com.yum.two_yum.R;
import com.yum.two_yum.utile.pickerview.TimePickerView;
import com.yum.two_yum.utile.pickerview.adapter.NumericWheelAdapter;
import com.yum.two_yum.utile.pickerview.lib.WheelView;
import com.yum.two_yum.utile.pickerview.listener.OnItemSelectedListener;
...
public class WheelTime {
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        if (label_year!=null){
            ...
            wv_year.setLabel(view.getContext().getString(R.string.YEAR));
        }
        if (label_month!=null){
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.MONTH));
        }
        if (label_day!=null){
            wv_day.setLabel(label_day);
        }else {
            wv_day.setLabel(view.getContext().getString(R.string.DAY));
        }
        if (label_hours!=null){
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.HOUR));
        }
        if (label_mins!=null){
            wv_mins.setLabel(label_mins);
        }else {
            wv_mins.setLabel(view.getContext().getString(R.string.MINUTE));
        }
        if (label_seconds!=null){
            wv_seconds.setLabel(label_seconds);
        }else {
            wv_seconds.setLabel(view.getContext().getString(R.string.SECOND));
        }
