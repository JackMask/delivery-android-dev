package com.yum.two_yum.utile.pickerview;
...
import com.yum.two_yum.utile.pickerview.lib.WheelView;
import com.yum.two_yum.utile.pickerview.listener.CustomListener;
import com.yum.two_yum.utile.pickerview.view.BasePickerView;
import com.yum.two_yum.utile.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public boolean MONTH_DAY_YEAR = false;
    ...
    public TimePickerView(Builder builder) {
        ...
        this.MONTH_DAY_YEAR = builder.MONTH_DAY_YEAR;
    ...
    public static class Builder {
        ...
        private boolean MONTH_DAY_YEAR;
        ...
        public Builder setMonthDayYear(boolean MONTH_DAY_YEAR){
            this.MONTH_DAY_YEAR = MONTH_DAY_YEAR;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            if (MONTH_DAY_YEAR){
                LayoutInflater.from(context).inflate(R.layout.pickerview_time_two, contentContainer);
            }else {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.YES) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.CLEAR) : Str_Cancel);
