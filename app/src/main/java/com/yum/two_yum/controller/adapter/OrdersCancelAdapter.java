...
public class OrdersCancelAdapter extends BaseCommAdapter<OrdersNewBase.DataBean.MerchantTodayOrderRespResultsBean> {
    ...
    public OrdersCancelAdapter(List<OrdersNewBase.DataBean.MerchantTodayOrderRespResultsBean> datas) {
        super(datas);
    }
