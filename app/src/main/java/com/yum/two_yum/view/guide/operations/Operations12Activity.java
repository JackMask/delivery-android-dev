...
public class Operations12Activity extends GuideBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operations12);
    ...
    private void getTimeItems() {
        options1Items.add(new ProvinceBean(0, "1.00", "", ""));
    }
    @OnClick({R.id.del_btn, R.id.save_out_btn, R.id.save_btn,R.id.delivery_btn})
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String s, int i) {
                        ...
                        if (clickType) {
                            ...
                            Intent intent = new Intent(Operations12Activity.this, Operations12AddActivity.class);
