...
public class Operations13Activity extends GuideBaseActivity {
    ...
    private String range = "5.00";
    private ArrayList<ProvinceBean> options1Items = new ArrayList<>();
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_operations13);
    ...
    private void getTimeItems() {
        options1Items.add(new ProvinceBean(0, "1.0", "", ""));
        options1Items.add(new ProvinceBean(0, "2.0", "", ""));
        options1Items.add(new ProvinceBean(0, "3.0", "", ""));
        options1Items.add(new ProvinceBean(0, "4.0", "", ""));
        options1Items.add(new ProvinceBean(0, "5.0", "", ""));
    }
    @OnClick({R.id.del_btn, R.id.save_out_btn, R.id.save_btn,R.id.select_area_btn})
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String s, int i) {
                        ...
                        if (clickType) {
                            ...
                            Intent intent = new Intent(Operations13Activity.this, Operations14Activity.class);
