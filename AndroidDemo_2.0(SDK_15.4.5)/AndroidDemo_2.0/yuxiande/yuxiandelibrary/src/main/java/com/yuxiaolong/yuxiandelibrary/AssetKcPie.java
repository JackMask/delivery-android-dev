...
import com.yuxiaolong.yuxiandelibrary.model.AssetKcData;
...
public class AssetKcPie extends View {//继承View类
    ...
    public AssetKcPie(Context context, AttributeSet attrs) {
        ...
        textPaint.setTextSize(YuXianDeUtile.dip2px(context,11));
        ...
        distance = YuXianDeUtile.dip2px(context,16);

        setRadius(YuXianDeUtile.dip2px(context,80));
    ...
    public void setLenged(){ //设置是否绘制控件下方的描述
        ...
        lengedHeight = (int) YuXianDeUtile.dip2px(mContext,32);
    ...
    private void drawLenged(){ //绘制控件下面的描述
        ...
        for(int i = 0;i<datas.size();i++){
            ...
            textPaint.setTextSize(YuXianDeUtile.dip2px(mContext,13));
    ...
    private void drwaLineAndText(float sweepAngle,float lineAngle,String desc,Rect rect,int i){
        ...
        textPaint.setTextSize(YuXianDeUtile.dip2px(mContext,11));
    ...
    private int onHeightMeasure(int height){
        ...
        int minSize = (int) YuXianDeUtile.dip2px(mContext,120);
