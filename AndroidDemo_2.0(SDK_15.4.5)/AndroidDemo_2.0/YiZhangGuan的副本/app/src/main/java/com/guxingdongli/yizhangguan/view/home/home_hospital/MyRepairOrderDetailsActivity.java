...
public class MyRepairOrderDetailsActivity extends YiZhangGuanActivity {
            ...
            tabList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (i == 0) {
                        ...
                        qrcodeIv.setImageBitmap(YuXianDeUtile.generateBitmap("二维码", YuXianDeUtile.dip2px(MyRepairOrderDetailsActivity.this, 260), YuXianDeUtile.dip2px(MyRepairOrderDetailsActivity.this, 260)));
    ...
    private void slidingData(List<String> dataList){
        ...
        for (int i =0 ; i < dataList.size();i++){
            ...
            Picasso.get().load(dataList.get(i)).placeholder(R.drawable.default_image).into(imageView);
